...
export interface Upgrade {
    id: string;
    name: LocalizedText;
    /** Narrative/flavor blurb - no mechanical info. */
    flavourText: LocalizedText;
    /** Short, factual summary of what the upgrade actually does. */
    effectText: LocalizedText;
    level: number;
    levelCap: number;
    prices: number[];
    dependency?: UpgradeDependency;
    x: number; // grid coordinate (px), infinite/pannable grid
    y: number; // grid coordinate (px), infinite/pannable grid
}
