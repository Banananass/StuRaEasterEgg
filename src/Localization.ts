...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
    de: {
        ...
        'menu.credits.programming': 'Nicolas Hentschel – Programmierung',
        'menu.credits.graphics': 'Niemand – Grafik',
        'menu.credits.sound': 'Niemand – Sound & Musik',
    ...
    en: {
        ...
        'menu.credits.title': 'Credits',
        'menu.credits.programming': 'Nicolas Hentschel – Programming',
        'menu.credits.graphics': 'Nobody – Graphics',
        'menu.credits.sound': 'Nobody – Sound & Music',
...
export class Localization {
    private static _locale: Locale = 'de';
    ...
    public static t(key: string, vars?: Record<string, string | number>): string {
     ...
     */
    public static applyStaticTranslations(): void {
